...
Servo myServo;  // 2019-12-28 - Using this as Servo kills PWM on 9 and 10 on Arduino
...
void loop()
{
  ...
  //********************************************//
  // Volt Meter - Uses A1 as input and 100K / 10K voltage divider
  //********************************************//
  //
  if(Mode==0)
  {
  ...
  if(Mode==1)
  {
    if(digitalRead(4)==0) // button to reset stats or inCommand of =1
    { 
